...
func SessionCreate(tx interface{}, op *database.DbOperations, user *domain.User) (*domain.Session, error) {
...
func SessionSetContext(tx interface{}, op *database.DbOperations, isAdmin bool) (*domain.Session, error) {
